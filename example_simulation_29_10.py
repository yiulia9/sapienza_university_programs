...
def func1(string_list1, string_list2):
    #intersezione al contrario
    #ordine crascente di len e se pari in ordine alfabetico inverso
    sorted_list=[]

    for el1 in string_list1:
        if el1 not in string_list2:
            sorted_list.append(el1)
    for el2 in string_list2:
        if el2 not in string_list1:
            sorted_list.append(el2)
    smal_el3=sorted_list[0]
    next_el3=sorted_list[pos_el3]
    pos_el3=1
    while smal_el3 in sorted_list:
        if smal_el3>next_el3:
            next_el3,smal_el3=smal_el3,next_el3
            pos_el3+=1
